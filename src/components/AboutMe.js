  ...
  return (
    <section className="aboutMe" id="aboutMe">
      ...
      <p className="aboutMe__text">
        ...
        technologies such as 4D design and motion graphics.{" "}
      </p>
      <p className="aboutMe__text">
      ...
      <p className="aboutMe__text">
        ...
        development because if there is something that I have always been clear
        about, it is that I want to work with a computer and that, along with my
        abilities and skills in terms of art, having been curious and
        self-taught and the great adaptability to new technologies, could bring
        my potential to its maximum in web development.
      </p>
    </section>
  );
};
