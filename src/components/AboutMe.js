      ...
      <div className="aboutMe__container">
        ...
        <p className="aboutMe__container--text one">
          <span>
            ...
            post-production of each video, knowing how to adapt to tight
            deadlines and all kinds of clients.
          </span>{" "}
        </p>
        <p className="aboutMe__container--text three">
          <span>
            ...
            such as 3D design and motion graphics. I consider myself a person
            with great adaptation to the needs of each project. In addition,
            having worked as a freelancer has been very rewarding. I have been
            able to work on projects that I was passionate about and where I had
            more freedom to apply the creativity that characterizes me.{" "}
          </span>
        </p>
        <p className="aboutMe__container--text three">
          {" "}
        ...
        <p className="aboutMe__container--text four">
          ...
          <span>
            {" "}
            In my free time I like to do analogue photography, just as a hobby,
            my "evil" side is finding the best taverns and bars to eat and drink
            in Madrid. Have I already mentioned that I have also been a
            waitress?
          </span>
        </p>
        <p className="aboutMe__container--text .one5">
          ...
          <span>
            ...
            clear about, it is that I want to work with a computer and that,
            along with my abilities and skills in terms of art, having been
            curious and self-taught and the great adaptability to new
            technologies, could bring my potential to its maximum in web
            development.
          </span>
        </p>
      </div>
